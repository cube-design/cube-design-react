...
const computeAnchorStyle = (props, context) => {
    const {
        d,
        pos,
        top,
    ...
    const style = [
        ...
        {
            ":visited": {
                ...makeResponsive(visitedColor, "color", context.colors)
            }
        },
        {
            ":active": {
                ...makeResponsive(activeColor, "color", context.colors)
            }
        },
        {
            ":focus": {
...
export default computeAnchorStyle;
